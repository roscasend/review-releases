(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-slide-slide-module"], {
    ...
    function srcAppPagesSlideSlidePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      "./node_modules/@angular/platform-browser/__ivy_ngcc__/fesm2015/platform-browser.js"); // import { FileOpener } from "@ionic-native/file-opener/ngx";


      var SlidePage = /*#__PURE__*/function () {
        function SlidePage(platform, loadingController, contentService, webview, domSanitizer) {
        ...
        _createClass(SlidePage, [{
          ...
          key: "resolveurlpdf",
          value: function resolveurlpdf(url) {
            var pth = this.contentPath.replace("downloadcontent", "downloadpdf");
            return url.includes("https://www.dropbox.com") ? url : pth + btoa(this.openedContent.dirname + "/" + "songlist/" + (url.substring(0, 3) == "../" ? "" : this.openedSong.url + "/") + (url.substring(0, 1) == "/" ? url.substring(1) : url).replace("../", ""));
          }
        }, {
          key: "loadSlide",
                    ...
                    case 0:
                      ...
                      return slides.forEach(function (e, i) {
                        ...
                        if (e["voiceover"] !== undefined && e["voiceover"] !== "") {
                          var voiceover = document.createElement("audio");
                          voiceover.id = "audio".concat(i);
                          voiceover.src = _this.resolveurl(e["voiceover"]);
              ...
              return regeneratorRuntime.wrap(function _callee4$(_context4) {
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    ...
                    case 4:
                      _context4.next = 6;
                      return document.querySelectorAll(".wrapper audio").forEach(function (e) {
                        elements.push(e);
                      });
          ...
          value: function hideLoading() {
            ...
            gsap__WEBPACK_IMPORTED_MODULE_4__["gsap"].fromTo("#wrapper" + this.currentSlide, {
              opacity: 0
            }, {
              opacity: 1,
              display: "flex",
          ...
          value: function changeVolume() {
            ...
            var el;
            document.querySelectorAll(".wrapper audio").forEach(function (e) {
              el = e;
          ...
          value: function openPDF() {
            ...
            var pdf = this.resolveurlpdf(this.songs.data.pdf);
          ...
          value: function runSlide() {
            ...
            this.pauseAll();
            var aud = document.getElementById("audio" + this.currentSlide);
            ...
            if (this.isPlaying && this.trueCurrentDuration !== 0) {
              this.changeTimer = setTimeout(function () {
                if (_this7.currentSlide >= _this7.slideCount - 1) {
                  ...
                  gsap__WEBPACK_IMPORTED_MODULE_4__["gsap"].to("#wrapper" + _this7.currentSlide, 0.5, {
                    opacity: 0,
                    display: "none"
                  });
            ...
            if (this.isPlaying && this.trueCurrentDuration !== 0) {
              this.changeTimer = setTimeout(function () {
                if (_this9.currentSlide >= _this9.slideCount - 1) {
                  ...
                  gsap__WEBPACK_IMPORTED_MODULE_4__["gsap"].to("#wrapper" + _this9.currentSlide, 0.5, {
                    opacity: 0,
                    display: "none"
                  });
