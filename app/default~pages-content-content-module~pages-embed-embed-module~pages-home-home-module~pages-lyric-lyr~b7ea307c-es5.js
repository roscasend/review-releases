        ...
        _createClass(ContentService, [{
          ...
          value: function definePath() {
            ...
            if (this.platform.is("desktop") && !this.platform.is("electron") || this.platform.is("mobileweb") || this.platform.is("pwa")) {
              ...
              pathh = this.file.externalApplicationStorageDirectory + "contents/";
            }
          ...
          value: function getJson(filename, cp) {
            ...
            return this.http.get(pathh + btoa(content.dirname + "/" + filename));
          }
        }, {
          key: "validateCode",
          value: function validateCode(code) {
            return this.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].resourceurl, "/validatecode/") + code, {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
              return data;
            }));
          }
        }, {
          ...
          value: function syncLicences() {
            ...
            return this.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].resourceurl, "/mylicences"), {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 11:
                      _context2.next = 13;
                      return this.file.checkDir(this.file.externalApplicationStorageDirectory, "contents").then(function () {
                        _this6.file.checkDir(_this6.file.externalApplicationStorageDirectory, "contents/" + content.dirname)["catch"](function () {
                          _this6.file.createDir(_this6.file.externalApplicationStorageDirectory, "contents/" + content.dirname, false);
                        });
                      })["catch"](function () {
                        _this6.file.createDir(_this6.file.externalApplicationStorageDirectory, "contents", false).then(function () {
                          _this6.file.checkDir(_this6.file.externalApplicationStorageDirectory + "contents/", content.dirname)["catch"](function () {
                            _this6.file.createDir(_this6.file.externalApplicationStorageDirectory + "contents/", content.dirname, false);
                          });
                        });
                    ...
                    case 13:
                      result = this.file.externalApplicationStorageDirectory + "contents/" + content.dirname;
                    ...
                    case 0:
                      ...
                      return this.checkDirExist(content).then(function (folder) {
                        if (_this7.platform.is("electron")) {
                          ...
                          _this7.file.listDir(_this7.file.externalApplicationStorageDirectory + "contents/", content.dirname).then(function (data) {
                            var files = [];
          ...
          value: function checkResourceList(content) {
            return this.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].resourceurl, "/getcontentlist/").concat(content.dirname), {});
          }
        }, {
          key: "compareContent",
          ...
          value: function deleteDownloadedContent(content) {
            if (this.platform.is("electron")) {
              ...
              var _pathh = this.file.externalApplicationStorageDirectory + "/contents/";
