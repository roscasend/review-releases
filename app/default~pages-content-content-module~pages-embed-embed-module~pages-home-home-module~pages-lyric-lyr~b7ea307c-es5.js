(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-content-content-module~pages-embed-embed-module~pages-home-home-module~pages-lyric-lyr~b7ea307c"], {
    /***/
    ...
    function srcAppServicesContentServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ContentService = /*#__PURE__*/function () {
        function ContentService(http, platform, file, transfer, storage) {
          ...
          this.hoverS = new Audio();
          this.clickS = new Audio();
          this.device = "web";
          this.definePath();
          this.hoverS.src = "assets/audio/hover.mp3";
          this.clickS.src = "assets/audio/click.mp3";
          this.hoverS.load();
          this.clickS.load();
        ...
        _createClass(ContentService, [{
          ...
          value: function checkDevice() {
            var device = "web";
            if (this.platform.is("desktop") || this.platform.is("mobileweb")) device = "web";
            if ((this.platform.is("ios") || this.platform.is("android")) && this.platform.is("mobileweb")) device = "web";
            if ((this.platform.is("ios") || this.platform.is("android")) && !this.platform.is("mobileweb")) device = "mobile";
            if (this.platform.is("electron")) device = "desktop";
            return device;
          }
        }, {
          key: "getDevice",
          value: function getDevice() {
            ...
            if (this.platform.is("desktop") || this.platform.is("mobileweb")) device = "web";
            if ((this.platform.is("ios") || this.platform.is("android")) && this.platform.is("mobileweb")) device = "web";
            if (this.platform.is("ios") && !this.platform.is("mobileweb")) device = "ios";
            if (this.platform.is("android") && !this.platform.is("mobileweb")) device = "android";
            if (this.platform.is("electron")) device = "desktop";
            return device;
          }
        }, {
          ...
          value: function definePath() {
            ...
            if (this.platform.is("desktop") && !this.platform.is("electron") || this.platform.is("mobileweb") || this.platform.is("pwa")) {
              pathh = "";
              ...
              pathh = path.join("file:///", app.getPath("userData"), "contents/");
            } else {
              pathh = this.file.externalApplicationStorageDirectory || this.file.dataDirectory + "contents/";
            }
          ...
          key: "getJson",
          value: function getJson(filename, cp) {
            var content = this.openedContent;
            var pathh = content.download_location;
            if (this.path !== "") pathh = this.path + content.dirname + "/";
            if (this.path !== "" && !this.platform.is("electron")) pathh = cp;
            var ext = this.platform.is("ios") && !this.platform.is("mobileweb") ? ".json" : "";
            return this.http.get(pathh + btoa(content.dirname + "/" + filename) + ext);
          }
        }, {
          key: "validateCode",
          value: function validateCode(code) {
            return this.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].resourceurl, "/validatecode/") + code + "/" + this.device, {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
              return data;
            }));
          }
        }, {
          ...
          value: function syncLicences() {
            ...
            return this.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].resourceurl, "/mylicences/") + this.device, {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
              return _this4.storeLicence(data);
            }));
          }
        }, {
          key: "storeLicence",
          value: function storeLicence(newLicence) {
            var _this5 = this;

            if (newLicence.status !== 200) return;
            newLicence = newLicence.data;
            var mylicences;
            var addedLicences = [];
            this.getStoredLicence().then(function (data) {
              mylicences = data;

              if (newLicence.length >= 1) {
                newLicence.forEach(function (e) {
                  e.downloaded = false;

                  if (mylicences.length >= 1) {
                    if (mylicences.some(function (el) {
                      return el.id == e.id;
                    })) return;
                    mylicences.push(e);
                    addedLicences.push(e);
                  } else {
                    mylicences.push(e);
                    addedLicences.push(e);
                  }
              ...
              if (addedLicences.length > 0) {
                _this5.storage.set(LKEY, mylicences);
              }
            });
            return addedLicences;
          }
        }, {
          key: "getStoredLicence",
          value: function getStoredLicence() {
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.next = 2;
                      return this.storage.get(LKEY).then(function (data) {
                        if (!data) data = [];
                        result = data;
                      });
          ...
          key: "checkDirExist",
          value: function checkDirExist(content) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
              var _this6 = this;

              var result, app, path, fs, pathh, pathh1;
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      pathh = path.join(app.getPath("userData"), "contents");
                      pathh1 = path.join(app.getPath("userData"), "contents", content.dirname);

                      if (!fs.existsSync(pathh)) {
                        fs.mkdirSync(pathh);
                      }

                      if (!fs.existsSync(pathh1)) {
                        fs.mkdirSync(pathh1);
                      }
                    ...
                    case 11:
                      _context2.next = 13;
                      return this.file.checkDir(this.file.externalApplicationStorageDirectory || this.file.dataDirectory, "contents").then(function () {
                        _this6.file.checkDir(_this6.file.externalApplicationStorageDirectory || _this6.file.dataDirectory, "contents/" + content.dirname)["catch"](function () {
                          _this6.file.createDir(_this6.file.externalApplicationStorageDirectory || _this6.file.dataDirectory, "contents/" + content.dirname, false);
                        });
                      })["catch"](function () {
                        _this6.file.createDir(_this6.file.externalApplicationStorageDirectory || _this6.file.dataDirectory, "contents", false).then(function () {
                          _this6.file.checkDir(_this6.path, content.dirname)["catch"](function () {
                            _this6.file.createDir(_this6.path, content.dirname, false);
                          });
                        });
                      });

                    case 13:
                      result = this.path + content.dirname;
          ...
          key: "checkFileList",
          value: function checkFileList(content) {
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      result = [];
                      _context3.next = 3;
                      return this.checkDirExist(content).then(function (folder) {
                        if (_this7.platform.is("electron")) {
                          var app = window.require("electron").remote.app;
                          ...
                          result = fs.readdirSync(pathh);
                        } else {
                          _this7.file.listDir(_this7.path, content.dirname).then(function (data) {
                            var files = [];
          ...
          key: "checkResourceList",
          value: function checkResourceList(content) {
            var ext = this.platform.is("ios") && !this.platform.is("mobileweb") ? "getcontentlistext" : "getcontentlist";
            return this.http.post("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].resourceurl, "/").concat(ext, "/").concat(content.dirname), {});
          }
        }, {
          key: "compareContent",
          value: function compareContent(content) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
              var resources, local, listToDownload;
              return regeneratorRuntime.wrap(function _callee4$(_context4) {
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      _context4.next = 2;
                      return this.checkResourceList(content).toPromise();

                    case 2:
                      resources = _context4.sent;
                      _context4.next = 5;
                      return this.checkFileList(content);
                    ...
                    case 5:
                      ...
                      _context4.next = 10;
                      return resources["data"].filter(function (obj) {
                        return local.indexOf(obj) == -1;
                      });

                    case 10:
                      listToDownload = _context4.sent;

                    case 11:
                      return _context4.abrupt("return", listToDownload);
          ...
          } // async startDownloading(content) {
          // }

        }, {
          key: "downloadFileElectron",
          value: function downloadFileElectron(configuration) {
            var fs = window.require("fs");
          ...
          key: "setDownloadedStatus",
          value: function setDownloadedStatus(content, status) {
            var _this8 = this;

            this.getStoredLicence().then(function (data) {
              if (data) {
                var licences = data.map(function (licence) {
                  return licence.id == content.id ? Object.assign(Object.assign({}, licence), {
                    downloaded: status
                  }) : licence;
                });

                _this8.storage.set(LKEY, licences);
              }
            });
          }
        }, {
          key: "emptyLicence",
          value: function emptyLicence() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
              return regeneratorRuntime.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      this.storage.remove(LKEY);
          ...
          key: "deleteDownloadedContent",
          value: function deleteDownloadedContent(content) {
            if (this.platform.is("electron")) {
              var app = window.require("electron").remote.app;
              ...
              this.setDownloadedStatus(content, false);
            } else {
              var _pathh = this.path;
              this.file.removeRecursively(_pathh, content.dirname);
              this.setDownloadedStatus(content, false);
            }
          }
        }, {
          key: "deleteDownloadedZip",
          value: function deleteDownloadedZip(content) {
            if (this.platform.is("electron")) {
              var app = window.require("electron").remote.app;
              ...
              var pathh = path.join(app.getPath("userData"), "contents", content.dirname, btoa(content.dirname) + ".zip");
              fs.unlinkSync(pathh);
            } else {
              var _pathh2 = this.path;
              this.file.removeFile(_pathh2 + "/" + content.dirname, btoa(content.dirname) + ".zip"); // this.file.removeRecursively(pathh, content.dirname);
            }
          }
        }, {
          key: "deleteContentFromStored",
          value: function deleteContentFromStored(content) {
              ...
              return regeneratorRuntime.wrap(function _callee6$(_context6) {
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    case 0:
                      _context6.next = 2;
                      return this.deleteDownloadedContent(content);

                    case 2:
                      _context6.next = 4;
                      return this.getStoredLicence().then(function (data) {
                        if (data) {
                          var licences = data.filter(function (el) {
                            return el.id != content.id;
                          });

                          _this9.storage.set(LKEY, licences);
                        }
                      });
      ...
      ContentService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
        providedIn: "root"
      })], ContentService);
      /***/
    }
...
//# sourceMappingURL=default~pages-content-content-module~pages-embed-embed-module~pages-home-home-module~pages-lyric-lyr~b7ea307c-es5.js.map