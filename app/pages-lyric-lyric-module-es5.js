        ...
        _createClass(LyricPage, [{
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      ...
                      this.backsongEl.src = this.backsong; // this.vocalEl = new Audio();
                      ...
                      this.lyrics.forEach(function (e, i) {
                        ...
                        if (e[1]["singer"] !== "") {
                          ...
                          singer.style.cssText = "display:block;min-height:8vh;line-height:8vh;font-size: clamp(1.2rem, 2vw, 2rem);";
                        ...
                        section.style.cssText = "display:block;min-height:20vh;line-height:22vh;font-size: clamp(2rem, 3.4vw, 3.4rem);font-weight:bold";
                        lyricwrap.style.cssText = "display:block;flex-grow:1;position:relative";
                        lyric.style.cssText = "display:block;font-size: clamp(1.6rem, 3.5vw, 4rem);position:absolute;width:100%;height:100%;top:0px;left:0px;font-weight:bold";
                        nolyric.style.cssText = "display:block;font-size: clamp(1.6rem, 3vw, 3rem);flex-grow:1;color:grey;position:absolute;width:100%;height:100%;top:0px;left:0px;font-weight:bold"; // singer.style.cssText =
                        ...
                        textss.forEach(function (el, il) {
                          ...
                          setTimeout(function () {
                            _this.animation.to("#text" + i + "t" + il, 0.1, {
                              color: "red",
                              y: -5
                            }, _this.convertTime(el[0]));
                          }, 1000);
                        });

                        _this.animation.from("#wrapper" + i, 0.1, {
                          opacity: 0,
                        ...
                        if (_this.lyrics.length - 1 > i) {
                          _this.animation.to("#wrapper" + i, 0.1, {
                            opacity: 0
          ...
          value: function updateSeeker() {
            ...
            this.seekerTimer = setInterval(function () {
              ...
              _this7.seeker = _this7.seeker + 100 / (_this7.currentDuration * 1000) * 1000;

              _this7.animation.progress(_this7.seeker / 1000);

              _this7.progress = _this7.convertDuration(_this7.seeker / 1000 * _this7.currentDuration);
              if (_this7.seeker >= 1000) clearInterval(_this7.seekerTimer);
              if (_this7.isPlaying == false) clearInterval(_this7.seekerTimer);
            }, 100);
            this.extendshowControl();
          }
        }, {
