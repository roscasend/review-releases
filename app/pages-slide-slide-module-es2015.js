...
/* harmony import */ var _ionic_native_document_viewer_ngx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic-native/document-viewer/ngx */ "./node_modules/@ionic-native/document-viewer/__ivy_ngcc__/ngx/index.js");
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var src_app_services_content_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/content.service */ "./src/app/services/content.service.ts");
...
let SlidePage = class SlidePage {
    constructor(platform, loadingController, contentService, webview, domSanitizer, iab, file, document // private fileOpener: FileOpener
    ) {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield slides.forEach((e, i) => {
                ...
                if (e["voiceover"] !== undefined && e["voiceover"] !== "") {
                    this.voiceover[`audio${i}`] = new Audio();
                    this.voiceover[`audio${i}`].src = this.resolveurl(e["voiceover"]);
                    this.voiceover[`audio${i}`].load();
                }
                let child;
                switch (e.type) {
                    case "image":
    ...
    doPreLoad() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            //   elements.push(e);
            // });
            let vo = Object.values(this.voiceover);
            vo.forEach((e) => {
                elements.push(e);
            });
    ...
    hideLoading() {
        ...
        gsap__WEBPACK_IMPORTED_MODULE_5__["gsap"].fromTo("#wrapper" + this.currentSlide, { opacity: 0 }, { opacity: 1, display: "flex", duration: 0.5 });
        this.initSlide();
    }
    convertTime(time) {
        let tm = time.split(":");
    ...
    runSlide() {
        this.pauseAll();
        let aud = this.voiceover[`audio${this.currentSlide}`];
        if (aud) {
            aud.play();
        }
